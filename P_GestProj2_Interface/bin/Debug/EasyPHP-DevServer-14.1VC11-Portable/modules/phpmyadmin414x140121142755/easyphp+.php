...
$module_info = array(
	...
	"en"	=>	array(
		"Application"	=>	array(
				...
				"Installation date"	=>	"2014-01-21 14:27:55",
				"Website"	=>	"<a href='http://www.phpmyadmin.net/' target='_blank'>www.phpmyadmin.net</a>"
		),
		"How to uninstall this module ?"	=>	array(
				"If you want to uninstall this module, you just have to<br />delete the folder"	=>	"<br />[modules folder]\\phpmyadmin414x140121142755",
		),	
	),
	"fr"	=>	array(
		"Application"	=>	array(
				"Nom"		=>	"PhpMyAdmin",
				"Version"	=>	$module_version,
				"Date d'installation"	=>	"2014-01-21 14:27:55",
				"Site web"	=>	"<a href='http://www.phpmyadmin.net/' target='_blank'>www.phpmyadmin.net</a>"
		),
		"Comment d&eacute;sinstaller ce module ?"	=>	array(
				"Si vous voulez d&eacute;sinstaller ce module, il suffit de supprimer le r&eacute;pertoire"	=>	"<br />[modules folder]\\phpmyadmin414x140121142755",
		),
	),	
);
